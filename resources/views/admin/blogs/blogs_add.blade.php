                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('store.blog') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_title" class="form-control" type="text"  id="short_title">
                                        @error('blog_title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_tags" class="form-control" value="home,room" type="text"  data-role="tagsinput">
                                    </div>
                                </div>
